...
Route::group([
    ...
    Route::group(['middleware' => ['admin.auth','permission']], function () {
        ...
        /** ManageKpi route */
        Route::resource('manageKpi', KpiController::class);
        // Route::get('posts/toggle-status/{id}', [KpiController::class, 'toggleStatus'])->name('posts.toggle-status');
        Route::get('kpis/delete/{id}', [KpiController::class, 'delete'])->name('manageKpi.delete');
        Route::get('kpis/get-All-posts/{deptId}', [KpiController::class, 'getAllActivePostsByDepartmentId'])->name('kpi.getAllPostsByBranchId');
        Route::get('/getKPIs', [KpiController::class, 'getKPIs']);
